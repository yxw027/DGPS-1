...
public class ResultRecords {
	...
	private final String BACKUP_SUB_PATH = "/DGNSS/RESULT_REC";
	...
	public void WriteRecordBreak(boolean bIsStartSession)
	{
		String strContent = String.format("============================================================\r\n============       %s    [%s]     ============\r\n============================================================\r\n", (bIsStartSession)? "Record Start":"Record End", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US).format(Calendar.getInstance().getTime()));
	...
	private String getDefaultFileName()
	{
		...
		return String.format("ResultRecords_%s.TXT",  new SimpleDateFormat("yyyy_MM_dd").format(curDate.getTime()));
	}	
